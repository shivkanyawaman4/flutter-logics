...
class _ScrollablePageState extends State<ScrollablePage> {
                ...
                children: [
                  ...
                  Expanded(
                    child: buildScrollingView(
                      ...
                      GridView(
          controller: scrollControllerVertical2,
          physics: const NeverScrollableScrollPhysics(),
          scrollDirection: axis,
          padding: const EdgeInsets.all(24.0),
  ...
  Widget buildScrollingView(
      Axis axis, ScrollController controller, Widget child) {
    return ImprovedScrolling(
      ...
      keyboardScrollConfig: KeyboardScrollConfig(
        arrowsScrollAmount: 500,
        arrowsScrollDuration: const Duration(milliseconds: 100),
